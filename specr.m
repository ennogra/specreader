...
% Revision 2015.03.06
%   (1) Call figure resize function at the end of initFigure for
%   compatibility of 2014b
...
hMenuToolsInvertY = uimenu(hMenuTools,...
    'Label','Invert &Y Axis',...
    'Callback','invertyaxis',...
    'HandleVisibility','callback',...
    'Tag','specr_MenuToolsInvertY');
...
hToolbarGrid = uitoggletool(hToolbar,...
    ...
    'State','on',...
    'Tag','toolbarGrid');
hToolbarScanPre = uipushtool(hToolbar,...
    'CData',icons.iconscanpre,...
    'Separator','on',...
    'TooltipString','Previous Scan',...
    'ClickedCallback','selectprenextscan',...
    'Tag','toolbarScanPre');
hToolbarScanNext = uipushtool(hToolbar,...
    'CData',icons.iconscannext,...
    'Separator','off',...
    'TooltipString','Next Scan',...
    'ClickedCallback','selectprenextscan',...
    'Tag','toolbarScanNext');
...
hToolbarInvert = uipushtool(hToolbar,...
    ...
    'Tag','toolbarInvert');
hToolbarInvertY = uipushtool(hToolbar,...
    'CData',icons.iconinverty,...
    'TooltipString','Invert Y Axis',...
    'ClickedCallback','invertyaxis',...
    'Tag','toolbarInvertY');
...
hToolbarSettings = uipushtool(hToolbar,...
    ...
    'Tag','toolbarSettings');
hToolbarMeshScanPlot = uipushtool(hToolbar,...
    'CData',icons.iconmeshscan,...
    'Separator','on',...    
    'TooltipString','Plot Mesh Scan',...
    'ClickedCallback','meshscanplot',...
    'Tag','toolbarMeshScanPlot');
...
% hPushbuttonSelectScanPre = uicontrol(hFigSpecr,...
%     'Style','pushbutton',...
%     'String','<<',...
%     'TooltipString',' Previous Scan',...
%     'Tag','specr_PushbuttonSelectScanPre',...
%     'callback',@selectscan);
% hPushbuttonSelectScanNext = uicontrol(hFigSpecr,...
%     'Style','pushbutton',...
%     'String','>>',...
%     'TooltipString',' Next Scan',...
%     'Tag','specr_PushbuttonSelectScanNext',...
%     'callback',@selectscan);
...
% --- call resize function to update GUI layout
specr_ResizeFcn(hFigSpecr);
...
hFigSpecr = hObject;
settings.wavelength = 1.686859478480;           % for 7.35 kev; 1.137469464847 for 10.9 kev
...
settings.monitorPeriod   = 2.0;  % scan monitor period (sec)
settings.monitorAutoPeriodMode = 1; % flag for automatic adjustment of monitor period       1/2: on/off
settings.monitorAutoPeriod = 2.0;   % automatic period
settings.monitorErasemode = 1;   % erase previous scans
settings.meshScanPlotType = 1;      % meahs scan plot type [1]/2/3/4: [contour]/contourf/mesh/surf
settings.meshScanPlotScale = 2;      % meahs scan plot scale 1/[2]: log/linear
settings.meshScanExport2WS = 2;   % export data to work space 1/[2]: yes/[no]
settings.file       = '';
settings.scan       = '';
settings.savepath   = '';
...
%hPushbuttonSelectScanPre = findall(hFigSpecr,'Tag','specr_PushbuttonSelectScanPre');
%hPushbuttonSelectScanNext = findall(hFigSpecr,'Tag','specr_PushbuttonSelectScanNext');
...
%     set(hPushbuttonSelectScanPre,...
%         'Units','Pixels',...
%         'Position',[PosFigureTopCenter(1)-310,PosFigureTopCenter(2),40,25]);            
%     set(hPushbuttonSelectScanNext,...
%         'Units','Pixels',...
%         'Position',[PosFigureTopCenter(1)-270,PosFigureTopCenter(2),40,25]);            
